...
import { DEMO_USERS, isDemoAuthEnabled, setAuthUser, useAuth } from "@/lib/auth-store";
...
function LoginPage() {
  ...
  const showDemo = isDemoAuthEnabled();
  ...
  function demoLogin(kind: "buyer" | "supplier" | "admin") {
    ...
    toast.success(`Signed in as ${DEMO_USERS[kind].fullName} (demo)`);
    go();
  }
              ...
              <div className="grid gap-2">
                ...
                >
                  ...
                  <span className="flex-1">
                    <b>Continue as Buyer</b>
                    <div className="text-[11px] text-muted-foreground">
                      Paco · Lola Nena's Carinderia Group
                    </div>
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="flex-1">
                    <b>Continue as Supplier</b>
                    <div className="text-[11px] text-muted-foreground">
                      Bulacan Grain & Rice Mills Inc.
                    </div>
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="flex-1">
                    ...
                    <div className="text-[11px] text-muted-foreground">PSG Supply Gateway</div>
                  </span>
                </button>
              </div>
            </>
